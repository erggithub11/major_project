...
@Composable
fun SundayScreenTopLevel(
    navController: NavHostController,
    dailiesViewModel: DailiesViewModel = viewModel()
){

    val dailyList by dailiesViewModel.sundayList.observeAsState(listOf())
...
@Composable
fun SundayScreen(modifier: Modifier = Modifier,
                   navController: NavHostController,
...
@Preview
@Composable
fun SundayScreenPreview(){
    val navController = rememberNavController()
    DailiesTheme{
        SundayScreenTopLevel(navController)
    }
}
