...
@Composable
fun ThursdayScreenTopLevel(
    navController: NavHostController,
    dailiesViewModel: DailiesViewModel = viewModel()
){

    val dailyList by dailiesViewModel.thursdayList.observeAsState(listOf())
...
@Composable
fun ThursdayScreen(modifier: Modifier = Modifier,
                 navController: NavHostController,
...
@Preview
@Composable
fun ThursdayScreenPreview(){
    val navController = rememberNavController()
    DailiesTheme{
        ThursdayScreenTopLevel(navController)
    }
}
