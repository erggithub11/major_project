...
@Composable
fun FridayScreenTopLevel(
    navController: NavHostController,
    dailiesViewModel: DailiesViewModel = viewModel()
){

    val dailyList by dailiesViewModel.fridayList.observeAsState(listOf())
...
@Composable
fun FridayScreen(modifier: Modifier = Modifier,
                navController: NavHostController,
...
@Preview
@Composable
fun FridayScreenPreview(){
    val navController = rememberNavController()
    DailiesTheme{
        FridayScreenTopLevel(navController)
    }
}
